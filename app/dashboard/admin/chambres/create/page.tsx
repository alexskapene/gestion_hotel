...
export default function CreateRoomPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Données de la chambre à enregistrer:", formData);
        ...
        <form onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(val) => setFormData({ ...formData, categoryId: val })}>
                      ...
                      <SelectContent>
                        <SelectItem value="c1">Standard</SelectItem>
                        <SelectItem value="c2">Deluxe</SelectItem>
                        <SelectItem value="c3">Suite</SelectItem>
                        <SelectItem value="c4">Présidentielle</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
          ...
          <CardFooter className="bg-muted/10 p-6 flex justify-between items-center border-t border-border mt-8">
            ...
            {currentStep < STEPS.length ? (
              ...
              >
                Créer la chambre <CheckCircle2 className="w-4 h-4" />
              </Button>
            )}
          </CardFooter>
        </form>
